...
final class MFSD_Super_Strengths {
    ...
    private function __construct() {
        ...
        // Hourly timeout enforcement cron
    ...
    public function register_assets() {
        wp_register_style(
            'mfsd-ss-css',
            MFSD_SS_URL . 'assets/mfsd-super-strengths.css',
            [],
            MFSD_SS_VERSION
        );
        wp_register_script(
            'mfsd-ss-js',
            MFSD_SS_URL . 'assets/mfsd-super-strengths.js',
            [],
            MFSD_SS_VERSION,
            true
        );
    ...
    public function shortcode() {
        ...
        $role_hint = ($age >= 11 && $age <= 14) ? 'student' : 'adult';

        // Free-text eligibility
        $ft_enabled = false;
        if ($age >= 13 && $age <= 14 && get_option('mfsd_ss_free_text_13_14') === '1') {
            $ft_enabled = true;
        } elseif ($age >= 11 && $age <= 12 && get_option('mfsd_ss_free_text_11_12') === '1') {
            $ft_enabled = true;
        }
